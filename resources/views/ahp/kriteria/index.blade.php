        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="text-right mb-3">
                    <a href="{{ route('ahp.kriteria.tambah') }}" class="btn btn-primary btn-sm rounded-0"><i
                        ...
                        <tbody>
                            ...
                            @foreach ($kriteria as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->nama }}</td>
                                    <td>
                                        <a href="{{ route('ahp.kriteria.ubah', $item->id) }}"
                                            class="btn btn-warning btn-sm rounded-0"><i class="fas fa-user-cog"></i>
                                            UBAH
                                        </a>
                                        <form action="{{ route('ahp.kriteria.hapus', $item->id) }}" method="POST"
                                            class="d-inline">
                                            @csrf
                                            @method('delete')
